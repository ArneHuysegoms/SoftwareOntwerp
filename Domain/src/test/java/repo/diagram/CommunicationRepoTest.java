...
public class CommunicationRepoTest{
    ...
    public void setUp() {
        try {
            ...
            communicationRepo = new CommunicationRepo();
    ...
    public void Test_default_constructor_works(){
        CommunicationRepo c = new CommunicationRepo();
        assertNotNull(c.getMessageRepo());
        assertNotNull(c.getLabelRepo());
        assertNotNull(c.getPartyRepo());
        assertTrue(c.getMessageRepo() instanceof CommunicationMessageRepo);
        assertFalse(c.getMessageRepo() instanceof SequenceMessageRepo);
    }
