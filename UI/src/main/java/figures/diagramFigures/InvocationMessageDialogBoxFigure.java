...
import figures.basicShapes.AddButtonFigure;
import figures.basicShapes.DownButtonFigure;
import figures.basicShapes.RemoveButtonFigure;
import figures.basicShapes.UpButtonFigure;
...
public class InvocationMessageDialogBoxFigure extends SubwindowFigure {
    ...
    private void drawListBox(Graphics graphics, int minX, int minY, int maxX, int maxY) {
        ...
        new figures.basicShapes.Rectangle(dialogBox.getArgumentListBox().getCoordinate(), ListBox.HEIGHT, ListBox.WIDTH);
    }
    ...
    private void drawTextBoxes(Graphics graphics, int minX, int minY, int maxX, int maxY) {
        ...
        new figures.basicShapes.Rectangle(dialogBox.getArgumentTextBox().getPosition(), TextBox.HEIGHT, TextBox.WIDTH).draw(graphics, minX, minY, maxX, maxY);
        new figures.basicShapes.Rectangle(dialogBox.getMethodTextBox().getPosition(), TextBox.HEIGHT, TextBox.WIDTH).draw(graphics, minX, minY, maxX, maxY);
    }
