...
public class StickMan extends Figure {
     ...
     *
     * @param x
     *      the x-coordinate of the top of the stickman's head
     * @param y
     *      the y-coordinate of the top of the stickman's head
     */
     ...
     *
     * @param headRadius
     *      the radius of the stikmans head
     * @param legSpread
     *      the width of the spread between the stickman's legs
     * @param legLen
     *      the length of the stickman's legs
     */
     ...
     * @return
     *      the point of the top of the stickman's head
     */
     ...
     * @return
     *      the point where the stickman's body and head meet
     */
     ...
     * @return
     *      the point where the stickman's body and legs meet
     */
     ...
     * @return
     *      the point where the stickman's body and arms meet
     */
     ...
     * @return
     *      a Circle that is the stickman's head
     */
     ...
     * @return
     *      a Line that is the stickman's body
     */
    public Line getBody() {
        return body;
    }
     ...
     * @return
     *      one line that are the two arms of a stickman
     */
    public Line getArms() {
        return arms;
    }
