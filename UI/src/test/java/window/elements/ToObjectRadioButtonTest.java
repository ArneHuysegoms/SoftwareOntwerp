...
public class ToObjectRadioButtonTest {

    @Test
    public void test_constructor() throws UIException {
        Command command = new ChangeToObjectCommand(null, null);
        ToObjectRadioButton tarb = new ToObjectRadioButton(command, new Point2D.Double(50,50), "RadioButton");
    ...
    public void test_empty_point_throws_exception() throws UIException{
        Command command = new ChangeToObjectCommand(null, null);
        ToObjectRadioButton tarb = new ToObjectRadioButton(command, null, "RadioButton");
    }
